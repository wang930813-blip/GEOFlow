        ...
        'letter' => [
            ...
            'blocks' => [
                ...
                [
                    'type' => 'list',
                    'items' => [
                        '首页主要承担导航作用，保留三步配置引导，并按单站点运营和多站点分发组织入口',
        ...
        'letter' => [
            ...
            'blocks' => [
                ...
                [
                    'type' => 'list',
                    'items' => [
                        'The dashboard is mainly a navigation hub, keeping the three-step setup guide and grouping entry points by single-site operations and multi-site distribution',
