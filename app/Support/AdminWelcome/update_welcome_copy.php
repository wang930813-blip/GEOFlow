...
return static function (array $welcomeState): array {
    ...
    return [
        'zh-CN' => [
            ...
            'letter' => [
                ...
                'blocks' => [
                    [
                        'type' => 'paragraph',
                        'content' => $titleZh !== '' ? $titleZh : '后台已经检测到 策影GEO 上游仓库有一个新版本可用。',
                    ],
                    [
                        'type' => 'paragraph',
        ...
        'en' => [
            ...
            'letter' => [
                'title' => 'A new 策影GEO version is available',
                'subtitle' => 'Current version v'.$currentVersion.', latest version v'.$latestVersion.'.',
                'blocks' => [
                    [
                        'type' => 'paragraph',
                        'content' => $titleEn !== '' ? $titleEn : 'The admin has detected that a newer 策影GEO release is available in the upstream repository.',
                    ],
                    [
                        'type' => 'paragraph',
