...
class DashboardController extends Controller
{
    ...
    public function openB2BWebsite(string $websiteKey, B2BIndustryWebsiteCatalog $b2bCatalog): RedirectResponse
    {
        ...
        return redirect()->route('admin.dashboard')->with('message', 'B2B行业网站已开通');
    }
