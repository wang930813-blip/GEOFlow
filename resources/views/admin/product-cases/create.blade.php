...
@section('content')
    <div class="space-y-6">
        <div class="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
            <div>
                <h1 class="text-2xl font-bold text-gray-900">New Product Case</h1>
                <p class="mt-1 text-sm text-gray-600">Create a product case and publish it to the public case library.</p>
            </div>
