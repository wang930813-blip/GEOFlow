@php
    ...
    $primaryMenu = [
        ...
        [
            ...
            'route' => 'admin.management-tools.index',
            'name' => '管理工具',
    ...
    $accountMenu = collect([
        ...
        ['key' => 'management_tools', 'route' => 'admin.management-tools.index', 'name' => '管理工具', 'icon' => 'wrench', 'visible' => $isSuperAdmin],
    ...
    $subMap = [
        ...
        'admin.management-tools.index' => 'management_tools',
        'admin.management-tools.product-case-import.create' => 'management_tools',
        'admin.management-tools.product-case-import.store' => 'management_tools',
        'admin.management-tools.product-case-import.show' => 'management_tools',
        'admin.management-tools.product-case-import.status' => 'management_tools',
        'admin.management-tools.product-cases.index' => 'management_tools',
        'admin.management-tools.product-cases.edit' => 'management_tools',
        'admin.management-tools.product-cases.update' => 'management_tools',
        'admin.management-tools.product-cases.toggle-status' => 'management_tools',
        'admin.management-tools.product-cases.destroy' => 'management_tools',
        'admin.manual-publish-stats.index' => 'manual_publish_stats',
        'admin.manual-publish-stats.store' => 'manual_publish_stats',
        'admin.manual-publish-stats.destroy' => 'manual_publish_stats',
