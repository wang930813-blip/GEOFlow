@php
    $navItems = [
        ...
        ['key' => 'products', 'label' => '产品服务', 'url' => route('site.products')],
        ['key' => 'news', 'label' => '资讯中心', 'url' => route('site.news')],
...
<header class="site-header" data-header>
    <div class="container header-inner">
        <a class="brand" href="{{ route('site.home') }}" aria-label="{{ $brandName }}">
            @if($brandLogo !== '')
        ...
        <div class="header-actions">
            ...
            <span class="magnetic-wrap"><a class="button button-small button-outline header-cta" data-magnetic href="{{ route('site.contact') }}">联系我们</a></span>
