...
@php
    ...
    <div class="ne-shell ne-layout">
                ...
                <section class="ne-feed-card">
                    ...
                    <div class="ne-feed">
                        @foreach($featuredArticles->take(5) as $article)
                            @include('theme.geoflow-template-16-newsletter-letter.partials.article-card', ['article' => $article, 'showFeaturedBadge' => true])
                        @endforeach
                    </div>
                </section>
            @endif
        ...
        @include('theme.geoflow-template-16-newsletter-letter.partials.sidebar', ['showFeedPanel' => $isDefaultHome])
    </div>
@endsection
