...
@section('content')
    ...
    <div id="mainContent" class="tx-shell tx-home-shell">
        @if($isDefaultHome)
            ...
            @include('theme.tech-insight-20260819.partials.brand-intro', ['brandIntroClass' => 'tx-home-brand'])

            <section class="tx-section tx-home-news">
                <div class="tx-home-section-head">
                    <div>
                        <span class="tx-eyebrow">资讯</span>
                        <h3>最新资讯</h3>
                    </div>
                    <a href="{{ route('site.news') }}" class="tx-link">
                        查看更多
                ...
                <div class="tx-article-grid">
                    @forelse($homeNewsArticles as $article)
