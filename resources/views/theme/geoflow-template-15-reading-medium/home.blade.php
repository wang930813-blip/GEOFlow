@extends('theme.geoflow-template-15-reading-medium.layout')
...
@php
    ...
    <div class="ne-shell ne-layout">
                ...
                <section class="ne-feed-card">
                    ...
                    <div class="ne-feed">
                        @foreach($featuredArticles->take(5) as $article)
                            @include('theme.geoflow-template-15-reading-medium.partials.article-card', ['article' => $article, 'showFeaturedBadge' => true])
                        @endforeach
                    </div>
                </section>
            @endif
            ...
            <section class="ne-feed-card">
                ...
                <div class="ne-feed">
                    @forelse($articles as $article)
                        @include('theme.geoflow-template-15-reading-medium.partials.article-card', ['article' => $article])
                    @empty
        ...
        @include('theme.geoflow-template-15-reading-medium.partials.sidebar', ['showFeedPanel' => $isDefaultHome])
    </div>
@endsection
